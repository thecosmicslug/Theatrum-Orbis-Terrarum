...
RandomWorld = {
	...
	colormap = {
		...
		plains_color_r			= 185, 
		plains_color_g			= 172, -- 97
		plains_color_b			= 151, -- 57  
		
		grasslands_color_r		= 185, -- 50
		grasslands_color_g		= 172, -- 60
		grasslands_color_b		= 151, -- 25
		
		mountain_color_r		= 185, -- 64
		mountain_color_g		= 172, -- 42
		mountain_color_b		= 151, -- 23
	...
	colormap_seasons = {
		-- Winter
		season0_overlay_percent			= 0.0,
		season0_color_r					= 200,
		season0_color_g					= 225,
		season0_color_b					= 255,
		
		-- Spring
		season1_overlay_percent			= 0.0,
		season1_color_r					= 180,
		season1_color_g					= 225,
		season1_color_b					= 200,

		-- Summer
		season2_overlay_percent			= 0.0,	
		season2_color_r					= 0,
		season2_color_g					= 150,
		season2_color_b					= 0,

		-- Autumn
		season3_overlay_percent			= 0.0,
		season3_color_r					= 150,
		season3_color_g					= 20,
		season3_color_b					= 0,		
	},
