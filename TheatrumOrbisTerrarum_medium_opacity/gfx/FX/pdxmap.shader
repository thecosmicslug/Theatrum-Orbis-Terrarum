	...
	[[
		...
		float4 main( VS_OUTPUT_TERRAIN Input ) : PDX_COLOR
		{
		...
		#endif
			{
				...
				colorRange = .1f * colorRange + .4f; //Medium Opacity
				...
				vOut = CalculateMapLighting( vOut, vHeightNormalSample )*1.3f; //regulates brightness of colored mapmodes on all zoom stages
